        ...
        <div id="#home" className={cn(
            ...
            <div className="flex flex-col gap-y-10 lg:py-20">
                <div className="flex flex-col gap-y-2 justify-center w-full">
                    <h1 className='text-2xl md:text-3xl lg:text-4xl'>I'm a Software Engineer.|</h1>
                    <span className='inline-flex gap-x-2 items-center'>
                    <p className='text-sm md:text-md'>Currently, I'm a Software Engineer as an freelancing  at  Fiver
